...
import (
	...
	"github.com/Kevionte/go-sovereign/consensus/misc/eip1559"
	...
	"github.com/Kevionte/go-sovereign/eth/gasestimator"
...
// NewEthereumAPI creates a new Sovereign protocol API.
...
// Version returns the current Sovereign protocol version.
...
func checkTxFee(gasPrice *big.Int, gas uint64, cap float64) error {
	...
	feeEth := new(big.Float).Quo(new(big.Float).SetInt(new(big.Int).Mul(gasPrice, new(big.Int).SetUint64(gas))), new(big.Float).SetInt(big.NewInt(params.Swc)))
