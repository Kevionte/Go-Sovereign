...
func (c *testChain) State() (*state.StateDB, error) {
	...
	if *c.trigger {
		...
		c.statedb.SetBalance(c.address, new(uint256.Int).SetUint64(params.Swc), tracing.BalanceChangeUnspecified)
		*c.trigger = false
	}
	return stdb, nil
}
...
func TestStateChangeDuringReset(t *testing.T) {
	...
	statedb.SetBalance(address, new(uint256.Int).SetUint64(params.Swc), tracing.BalanceChangeUnspecified)
