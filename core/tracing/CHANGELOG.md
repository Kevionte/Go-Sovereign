...
There has been a major breaking change in the tracing interface for custom native tracers. JS and built-in tracers are not affected by this change and tracing API methods may be used as before. This overhaul has been done as part of the new live tracing feature ([#29189](https://github.com/Kevionte/Go-Sovereign/pull/29189)). To learn more about live tracing please refer to the [docs](https://geth.ethereum.org/docs/developers/evm-tracing/live-tracing).
...
[unreleased]: https://github.com/Kevionte/Go-Sovereign/compare/v1.14.0...master
[v1.14.0]: https://github.com/Kevionte/Go-Sovereign/releases/tag/v1.14.0
[v1.14.3]: https://github.com/Kevionte/Go-Sovereign/releases/tag/v1.14.3
