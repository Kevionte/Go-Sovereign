...
var Defaults = Config{
	...
	NetworkId:          4330, // enable auto configuration of networkID == chainID
...
// Config contains configuration options for SWC and LES protocols.
type Config struct {
	// The genesis block, which is inserted if the database is empty.
	// If nil, the Sovereign main net block is used.
	...
	// State scheme represents the scheme used to store sovereign states and trie
	...
	// send-transaction variants. The unit is swc.
	RPCTxFeeCap float64
